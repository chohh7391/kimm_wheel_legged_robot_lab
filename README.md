...
- Using a python interpreter that has Isaac Lab installed, install the library in editable mode using:
    ...
    python -m pip install -e source/kimm_wheel_legged_robot_lab
...
We provide an example UI extension that will load upon enabling your extension defined in `source/kimm_wheel_legged_robot_lab/kimm_wheel_legged_robot_lab/ui_extension_example.py`.
...
```json
{
    "python.analysis.extraPaths": [
        "<path-to-ext-repo>/source/kimm_wheel_legged_robot_lab"
    ]
}
```
