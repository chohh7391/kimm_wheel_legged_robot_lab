...
@configclass
class KimmWheelLeggedRobotDrivingFixedHipRoughEnvCfg(KimmWheelLeggedRobotDrivingRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        if self.__class__.__name__ == "KimmWheelLeggedRobotDrivingFixedHipRoughEnvCfg":
