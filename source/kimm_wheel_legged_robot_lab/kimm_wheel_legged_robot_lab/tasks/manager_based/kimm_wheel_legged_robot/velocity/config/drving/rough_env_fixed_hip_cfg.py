...
# Pre-defined configs
##
from kimm_wheel_legged_robot_lab.assets import KIMM_WHEEL_LEGGED_ROBOT_DRIVING_MODE_FIXED_HIP_CFG # isort: skip
...
@configclass
class KimmWheelLeggedRobotDrivingRewardsCfg(RewardsCfg):
...
@configclass
class KimmWheelLeggedRobotDrivingRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    actions: KimmWheelLeggedRobotDrivingActionsCfg = KimmWheelLeggedRobotDrivingActionsCfg()
    ...
    def __post_init__(self):
        ...
        # ------------------------------Sence------------------------------
        self.scene.robot = KIMM_WHEEL_LEGGED_ROBOT_DRIVING_MODE_FIXED_HIP_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
