...
# Pre-defined configs
##
from kimm_wheel_legged_robot_lab.assets import KIMM_WHEEL_LEGGED_ROBOT_DRIVING_MODE_FIXED_HIP_ANKLE_CFG  # isort: skip
...
class KimmWheelLeggedRobotDrivingRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    foot_link_name = ".*_foot_link" # foot_link is contained in knee_link -> but not 
    wheel_link_name = [
