...
@configclass
class KimmWheelLeggedRobotDrivingFixedHipAnkleRoughEnvCfg(KimmWheelLeggedRobotDrivingRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        if self.__class__.__name__ == "KimmWheelLeggedRobotDrivingFixedHipAnkleRoughEnvCfg":
