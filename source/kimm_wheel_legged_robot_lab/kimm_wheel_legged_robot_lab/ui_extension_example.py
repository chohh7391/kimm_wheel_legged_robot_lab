...
def some_public_function(x: int):
    print("[kimm_wheel_legged_robot_lab] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[kimm_wheel_legged_robot_lab] startup")
    ...
    def on_shutdown(self):
        print("[kimm_wheel_legged_robot_lab] shutdown")